...
<body>
  ...
  <nav class="navbar navbar-light bg-light static-top">
    <div class="container">
      <a class="navbar-brand" href="http://nirma.id/tracking/nirma-admin.html">Nirma Admin</a>
      <a class="btn btn-danger" href="http://nirma.id/tracking/create_costumer.html">Tambah Costumer</a>
      <a class="btn btn-danger" href="http://nirma.id/tracking/create_record.html">Tambah Kegiatan</a>
      <a class="btn btn-danger" href="http://nirma.id/tracking/list.php">Cek Semua Data</a>
    </div>
  </nav>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <h1 class="mb-5">Tambahkan Costumer ke Sistem</h1>
          <?php
...
$sql = "INSERT INTO dataNirma (noorder, tanggal, jam, jeniskegiatan, detail, lampiran)
VALUES ('$noorder', '$tanggal', '$jam', '$jeniskegiatan','$detail', '$lampiran')";

if ($conn->query($sql) === TRUE) {
  echo "Anda Sudah Menambahkan Record";
} else {
        ...
        <div class="col-lg-6 h-100 text-center text-lg-right my-auto">
          <ul class="list-inline mb-0">
            <li class="list-inline-item mr-3">
              <a href="http://wa.me/62881023528616">
                <i class="fab fa-whatsapp fa-2x fa-fw"></i>
              </a>
            </li>
            <li class="list-inline-item mr-3">
              <a href="http://line.me/ti/p/~@929atzca">
                <i class="fab fa-line fa-2x fa-fw"></i>
              </a>
            </li>
            <li class="list-inline-item">
              <a href="http://instagram.com/nirma.indonesia">
